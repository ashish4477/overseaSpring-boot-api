	...
	<div class="bd">
		...
		<c:if test="${fn:containsIgnoreCase(param.redirect,'/rava/')}">
			<div class="rava video">
				<strong><a href="https://www.youtube.com/watch?v=ZGy3yxAm-Es" target="_blank" class="ceebox video-link">How to Request <br />Your Absentee Ballot</a></strong>
				<br />
			...
			<c:if test="${fn:containsIgnoreCase(param.redirect,'/domestic_registration/') || fn:containsIgnoreCase(param.redirect,'/domestic_absentee/')}">
				<p class="ovf-link"><b>Overseas Citizens and Military Voters:</b><br />
