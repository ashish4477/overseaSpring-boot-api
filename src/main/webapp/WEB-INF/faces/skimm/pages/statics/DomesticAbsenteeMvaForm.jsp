...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-sm-offset-6" style="margin-top:20px;">
    <h3>Sign up for more news from theSkimm</h3>
    <fieldset class="mailing-list-opt-in overseas">
        <div class="checkbox">
            <label><input type="checkbox" id = "optIn" name="optIn" value="false" class="checkbox"/> Get all the news you need to start your day. Plus special 2020 election coverage.</label>
        </div>
    </fieldset>
    </div>
</div>
...
<script>
    $("#optIn").prop('checked',"${param.optIn}")
