    ...
    <div class="bd-inner">
        ...
        <c:set var="formType" value="Form"/>
          ...
          <div class="security-recommendation">
              ...
              <h2>* You'll lose the request form you just filled out if you close this window. Download it now or wait for it to hit your inbox later. You've been warned.</h2>
          </div>
