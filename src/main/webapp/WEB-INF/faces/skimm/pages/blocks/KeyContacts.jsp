...
<div class="col-xs-12">
  <h3>${leo.eodRegion.name}, ${selectedState.name} <a style="font-size:12px; font-weight:normal;" href="<c:url value="/eoddomestic.htm"><c:param name="submission" value="true"/><c:param name="stateId">${selectedState.id}</c:param><c:param name="regionId">${user.eodRegionId}</c:param> </c:url> ">(View More Details)</a></h3>
  <br/>
	<div class="col-xs-6">
    <dl>
      ...
      <dd class="content">
        ...
        <br/>
         <a class="button small" href="<c:url value="/eoddomestic.htm"><c:param name="submission" value="true"/><c:param name="stateId">${selectedState.id}</c:param><c:param name="regionId">${user.eodRegionId}</c:param> </c:url> ">Check Yours Here</a>
      </dd>
   <dt>
 </dl>
	</div>
