...
<div id="voter-account-page" class="voter-account-page page-form body-content content column wide-content">
    <div class="hd">
        <div class="hd-inner">
            ...
            <div class="mva account nav">
                <ul>
                    <li><a href="<c:url value="/UpdateAccount.htm"/>">Update Account</a> |</li>
                    <li><a href="<c:url value="/ChangePassword.htm"/>">Change Password</a> |</li>
                    <li><a href="<c:url value="/RemoveAccount.htm"/>">Remove Account</a>  |</li>
        ...
        <div class="bd-inner">
            ...
            <div style="padding:12px 22px; border:solid #ccc 1px; background-color:#fff;" class="rounded-5">
                ...
                <ul class="actions">
                    ...
                    <li><a href="<c:url value="/FwabStart.htm"/>">Federal Write-In Absentee Ballot</a> <span class="hint"><strong>(Use only if your ballot is late - </strong><a href="https://vhd.overseasvotefoundation.org/unified/index.php?group=ovf&_m=knowledgebase&_a=view&parentcategoryid=46&pcid=&nav=" class="more" target="_top"><cite><strong>more info..</strong></cite></a>)</span></li>
                </ul>
            </div>
            <p>&nbsp;</p>
<%--
