...
<div class="column ${styleClass} wide-content page-form rava-intro">
  <h1 class="title text-center">What Type of Voting Form Would You Like to Prepare?</h1>
  <br/>
  ...
  <div class="row">
    <div class="col-12 form-type-selection">
  <fieldset>
    <div class="row">
      <div class="col-12 col-sm-4 domestic form-type">
      ...
      <div class="col-12 col-sm-4 overseas form-type">
    ...
    required="required" /> Voter Registration &<br/> Absentee Ballot Request</label>
      ...
      <div class="col-12 col-sm-4 military form-type">
    ...
    <br/>
    <div class="row fwab">
      <section class="col-10 col-offset-1">
         <footer>
