            ...
            <div id="collapseEodLeoAdditional" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
              <div class="panel-body no-table">
                <div class="accordian-sect office-hours">
                  <dl class="row"><dt class="col-12 col-sm-6"><h4>Office Hours</h4></dt>
                    <dd class="col-12 col-sm-6">
                      <c:choose>
                ...
                <div class="accordian-sect further-instructions">
                  <dl class="row"><dt class="col-12 col-sm-6"><h4>Further instructions</h4></dt>
                    <dd class="col-12 col-sm-6">
                      <c:choose>
                ...
                <div class="accordian-sect voter-registration-or-status-inquiry last">
                  <dl class="row"><dt class="col-12 col-sm-6"><h4>Am I Registered?</h4></dt>
                    <dd class="col-12 col-sm-6">${amIRegistered}</dd>
                  </dl>
                </div>
              </div>
            </div>
