    ...
    <div class="row">
      ...
      <fieldset class="row">
        ...
        <label>Voter Type</label>
          <form:select path="voterType" class="form-control" placeholder=".col-4">
      ...
      <div class="row">
      <div class="col-12 participation inline-checkboxes">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <fieldset class="row">
              <div class="col-12 col-sm-4 inline-checkboxes">
          ...
          <div class="col-12 col-sm-4 inline-checkboxes wrap">
       ...
       <div class="row">
         <div class="col-12">
            <h3>Satisfaction</h3>
            <fieldset class="col-12 inline-checkboxes">
