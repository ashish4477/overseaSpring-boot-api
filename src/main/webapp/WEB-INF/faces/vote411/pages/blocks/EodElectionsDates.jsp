...
<div class="row">
  <div class="col-12 <c:if test="${empty localElections}">text-center</c:if>">
    ...
    <c:forEach items="${localElections}" var="election">
      <div class="row show-grid election-dates">
        <c:if test="${election.stateId ne stateInfoId}">
          ...
          <div class="col-12 state-name" id="${election.stateAbbr}">
        ...
        <c:if test="${empty level or election.sortOrder ne level}">
          ...
          <div class="col-12 election-level" id="${level.name}">
            <h2><h4>${level.name} Elections</h4></h2>
          </div>
        </c:if>
        <div class="col-12 election-title"><h2>${election.heldOn} - ${election.title}</h2></div>
      </div>
      <div class="row show-grid match-my-cols election-dates domestic">
        <div class="col-12 col-sm-3 "><h3>Voter Registration Deadline</h3> ${election.domesticRegistration}</div>
        <div class="col-12 col-sm-3"><h3>Absentee Ballot Request Deadline</h3> ${election.domesticBallotRequest}</div>
        <div class="col-12 col-sm-3"><h3>Absentee Ballot Return Deadline</h3> ${election.domesticBallotReturn}</div>
      ...
      <c:if test="${not empty election.domesticNotes}">
        <div class="row show-grid">
          <div class="col-12 additional-note">
  ...
  <c:if test="${param.uocava && not empty localElections}">
    ...
    <c:forEach items="${localElections}" var="election">
      ...
      <div class="row show-grid match-my-cols election-dates uocava">
        <div class="col-12 col-sm-4"><h3>Voter Registration Deadline</h3>
        ...
        <div class="col-12 col-sm-4"><h3>Ballot Request Deadline</h3>
        ...
        <div class="col-12 col-sm-4"><h3>Ballot Return Deadline</h3>
  ...
  <c:if test="${not empty param.stateName && empty localElections}">
    <div class="col-12 col-sm-6 offset-sm-3 text-center alert alert-danger" style="margin-bottom:12px;">
...
<div class="row">
  <div class="col-12 col-sm-6 offset-sm-3 col-md-6 offset-md-3 text-center">
...
<div class="row">
  <div class="col-12">
    <p class="text-center"><a href="/vote/PrimaryElections.htm">Primary Elections Chart</a></div>
  </div>
</div>
