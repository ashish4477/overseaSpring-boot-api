...
<fieldset class="voterInfo">
  <div class="row form-group">
    <div class="voterType">
       <div class="col-4"> <form:label	for="voterType" path="voterType" cssErrorClass="error" class="required label-control">Voter Type *</form:label>
       </div>
       <div class="col-8">
  ...
  <div class="row form-group">
    ...
    <div class="col-4"><form:label for="voterHistory" path="voterHistory" cssErrorClass="error" class="required label-control">Voting History <c:if test="${empty userValidationFieldsToSkip['voterHistory']}">*</c:if></form:label>
    </div>
    <div class="col-8">
...
<div class="row">
  ...
  <div class="col-12 col-sm-6 <c:if test="${wizardContext.flowType eq 'FWAB'}">offset-sm-6</c:if>">
