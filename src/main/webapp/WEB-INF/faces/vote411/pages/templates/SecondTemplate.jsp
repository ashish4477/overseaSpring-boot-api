...
<div class="row top">
  <div class="container">
    <div class="col-4 col-sm-3 col-md-4 d-xs-none">&nbsp;</div>
    <div class="col-12 col-sm-9 col-md-8 site-login">
...
<div class="row top">
  <div class="container">
        <div class="col-4 col-sm-3 col-md-4"><a class="logo navbar-btn" href="/" title="Home">
  <img class="d-xs-none d-sm-none pull-left" src="/sites/all/themes/usvote_bootstrap_subtheme/logo.png" alt="Home">
  <img class="d-xs-block d-sm-block center-block img-responsive" src="/sites/all/themes/usvote_bootstrap_subtheme/logo_sm.png" alt="Home">
  </a></div>
      <div class="col-8 col-sm-9 col-md-8 pull-right slogan">
  ...
  <div class="row mva-account">
    <div class="container">
      <div class="col-12 account-nav">
        ...
        <div class="col-10 col-sm-5 user">
        ...
        <div class="col-12 col-sm-6 thanks d-xs-none d-sm-none">
      ...
      <div class="col-12 account-sub-nav">
         <div class="row">
