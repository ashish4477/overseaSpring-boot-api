          ...
          <div class="row mva-account">
            <div class="container">
              <div class="col-xs-12 account-nav">
                <div class="row">
                  <div class="col-xs-2 col-sm-2 col-md-1" style="display: none;">
                  ...
                  <div class="col-xs-12 col-sm-6 thanks hidden-xs hidden-sm">
                    <c:if test="${not empty membershipStat}">
                      ...
                      <c:forEach var="myear" items="${membershipStat}">
                      <div class="membership stat"> Election ${myear}</div>
                      </c:forEach>
                    </c:if>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-10">
                    <ul>
                      ...
                      <li class="donate"><a href="${baseURL}/donate">Donate</a></li>
                    </ul>
                  </div>
                </div>
              </div>
