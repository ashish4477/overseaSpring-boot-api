...
<fieldset class="votingAddress">
  ...
  <div class="row form-group">
      <div class="addressOptions ruralRoute col-xs-12 col-sm-5">
         <div class="checkbox">
           <label><form:checkbox path="votingAddress.typeName" id="ruralRoute" value="RURAL_ROUTE"/> <span>Use Rural Route</span></label>
        </div>
       </div>
      <div class="addressOptions addressDescribed col-xs-12 col-sm-7">
        <div class="checkbox">
          <label><form:checkbox path="votingAddress.typeName" id="addressDescribed" value="DESCRIBED"/> <span>Use Address Description</span></label>
        </div>
        </div>
  </div>
  <form:errors path="votingAddress" class="errorMsg" />
        <div class="street1 form-group" id="votingAddressStreet1">
            ...
            <form:input path="votingAddress.street1" cssErrorClass="error form-control" class="form-control" />
            <form:errors path="votingAddress.street1" class="errorMsg" />
        </div>
        <div id="votingAddressDescription" class="addressDescription form-group">
          <form:label for="votingAddress.description" path="votingAddress.description" cssErrorClass="error" class="label-control">Address Description *</form:label>
        ...
        <div id="votingAddress2" class="street2 form-group">
            ...
            <form:input path="votingAddress.street2" cssErrorClass="error form-control" class="form-control" />
        ...
        <div class="city form-group">
            ...
            <form:input path="votingAddress.city" cssErrorClass="error form-control" class="form-control"/>
            <form:errors path="votingAddress.city" class="errorMsg" />
        </div>
        <a id="updateRequired"></a>
       <div class="county form-group">
            <form:label	for="votingAddress.county" path="votingAddress.county" cssErrorClass="error form-control" class="label-control">County</form:label>
        ...
        <div class="state form-group">
            ...
            <form:select path="votingAddress.state" cssErrorClass="error form-control" multiple="false" class="form-control">
                <form:option value="" label="- Select -"/>
                <c:forEach items="${states}" var="state">
                  <c:if test="${state.abbr != 'PR'}">
                    <form:option value="${state.abbr}" label="${state.name}"/>
                  </c:if>
                </c:forEach>
            </form:select>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8">
        <div class="zip form-group">
            ...
            <form:input path="votingAddress.zip" maxlength="5" cssErrorClass="error form-control" class="form-control" />
      ...
      <div class="col-xs-12 col-sm-4">
        <div class="zip4 form-group">
            ...
            <form:input path="votingAddress.zip4" maxlength="4" cssErrorClass="error form-control" class="form-control"/>
