...
<form:form modelAttribute="${modelAttr}" action="${action}" method="post" name="${fname}" id="${fid}" role="form" autocomplete="off">
<div class="row">
  <div class="col-xs-12">
...
<%--            &lt;%&ndash;<p><a href="<c:url value="/UpdateAccount.htm"/>">Click here to update your account information</a></p>&ndash;%&gt;--%>
<%--        </div>--%>
<%--    </c:if>--%>
