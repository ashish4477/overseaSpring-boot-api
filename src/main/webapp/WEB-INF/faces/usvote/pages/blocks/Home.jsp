        ...
        <div class="grid_14 inner">
			...
			<div class="grid_16 content-bottom">
				<div class="video grid_5">
					<a href="https://www.youtube.com/watch?feature=player_embedded&v=QSPF2z-ynSM" class="ceebox video-link"><img src="<c:url value='/img/video.jpg'/>"/></a>
				</div>
...
<div class="grid_16 content-bottom">
  ...
  <div class="video grid_6">
    <a href="/voting-and-elections-summit" style="position:relative; left:-6px;"><img src="<c:url value='/img/2014_summit_logo_home.jpg'/>"/></a>
	</div>
