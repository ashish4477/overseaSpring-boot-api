...
<body class="${sectionName} fixed ohio">
<div class="container wrapper">
    <div>
        <div class="row heading">
            <div class="span4">
                <a href="<c:url value="/home.htm"/>" class="brand">
                    <img src="<c:url value='/img/backgrounds/logo.svg' />" class="logo">
                </a>
            </div>
        </div>
        <!--/.nav-collapse -->
                        ...
                        <ul class="nav nav-pills">
                            <li class="mva dropdown active">
                                ...
                                <ul aria-labelledby="drop4" role="menu" class="dropdown-menu" id="menu1">
                                    <li role="presentation"><a href="<c:url value="/MyVotingInformation.htm"/>" tabindex="-1" role="menuitem">Voter Account</a></li>
        ...
        <div class="row">
            <div class="span3">
                <c:import url="/WEB-INF/${relativePath}/pages/statics/LeftMenu.jsp">
                    <c:param name="cStateId" value="39" />
                    <c:param name="cStateAbbr" value="OH" />
                    <c:param name="cStateName" value="Ohio" />
                </c:import>
            </div><!--/span-->
            <div class="span9">
