...
<div id="eod-form" class="voter-account-page wide-content <c:if test="${not (isSvid and isEod)}">svid </c:if>column-form">
	<div class="span10 offset1">
		<h1 class="title">My Dates and Deadlines</h1>
	</div>
	<div class="bd span10 offset1" style="margin-left:50px;">
				...
				<div class="pnl">
					<c:forEach items="${localElections}" var="election" varStatus="inx">
						<table class="accordian-content rounded-5 election-deadlines" cellspacing="0">
							...
							<tr class="r0">
								<td class="first-col" colspan="3">${election.title} held on ${election.heldOn}</td>
							</tr>
							<tr class="r1">
							...
							<tr class="r2">
								...
								<td class="b-left">${election.domesticRegistration}</td>
							</tr>
							<tr class="r3">
								<td class="first-col" colspan="2"><h4>Absentee Ballot Request</h4></td>
								<td class="b-left">${election.domesticBallotRequest}</td>
							</tr>
							<tr class="r4">
								<td class="first-col" colspan="2"><h4>Absentee Ballot Return</h4></td>
								<td class="b-left">${election.domesticBallotReturn}</td>
							</tr>
							<tr class="r5">
								<td class="first-col" colspan="2"></td>
