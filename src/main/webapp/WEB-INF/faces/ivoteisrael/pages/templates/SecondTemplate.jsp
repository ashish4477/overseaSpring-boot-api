...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  ...
  <link type="text/css" rel="stylesheet" href="https://netdna.bootstrapcdn.com/bootstrap/3.0.2/css/bootstrap.min.css" media="all" />  <script src="<c:url value="/js/bootstrap/bootstrap.min.js"/>" type="text/javascript"></script>
...
<body class="home ivoteisrael page page-id-697 page-template-default donate td-custom-background td-custom-background td-custom-background td-custom-background td-custom-background wpb-js-composer js-comp-ver-3.6.8 vc_responsive custom-background">
