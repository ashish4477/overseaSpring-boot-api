 ...
 <div class="col-xs-12 col-sm-10 col-sm-offset-1">
  ...
  <c:choose>
    <c:when test="${not empty existed}">
      ...
      <div id="forgot-password" style="margin-left:90px; margin-top:-10px;"><a href="<c:url value="/RemindPassword.htm"/>">Forgot Password?</a></div><br/>
    </c:when>
    <c:otherwise>
			<h2>Please Enter a Password to Create a Voter Account</h2>
