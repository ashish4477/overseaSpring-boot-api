  ...
  <div class="col-xs-12">
    <div id="eod-form" class="<c:if test="${not (isSvid and isEod)}">svid </c:if>page-form">
      <div class="hd">
        <div class="hd-inner">
          <c:if test="${isEod}">
            <h1>Election Official Directory</h1>
          </c:if>
        </div>
      </div>
      <div class="bd">
        <div class="bd-inner">
          ...
          <c:if test="${not empty leo}">
              ...
              <div class="pnl">
                <div class="accordian-content rounded-5">
                  <c:if test="${empty leo.officers && empty leo.generalEmail}">
                    <div class="accordian-sect empty"><p>none on record</p>
                      <div class="break"></div>
                    </div>
                  </c:if>
            ...
            <c:choose>
              <c:when test="${not empty leo.website}">
                <h4 style="text-align:right; padding-right:40px;">
                  Local Elections Website: <a href="<c:out value='${leo.website}'/>" target="_blank">Visit Official Website</a>
                </h4>
              </c:when>
            </c:choose>
            <br/>
          ...
          <h2 class="title"><c:if test="${isSvid}">State Voter Information Directory</c:if></h2>
          <c:if test="${not empty stateVoterInformation}">
          <h3><c:out value='${selectedState.name}' /> Statewide Voter Information</h3>
          <div class="clearfix"></div>
          <h4><strong>For Overseas and Military Voters</strong></h4>
          ...
          <div id="transoptionsDomestic" class="accordian rounded-5">
          ...
          <div id="statelookuptools" class="accordian rounded-5">
            <h5 class="ctrl">Am I Registered?</h5>
            <div class="pnl" style="display:none">
              <table class="accordian-content rounded-5 election-deadlines" cellspacing="0">
