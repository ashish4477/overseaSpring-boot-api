...
<div class="col-xs-12">
  ...
  <c:when test="${wizardContext.flowType == 'RAVA'}">
      <p>If you have already requested an absentee ballot but have not yet received it, you can still vote by using the <a href="/vote/FwabStart.htm">Federal Write-In Absentee Ballot (FWAB).</a>
</p>
  </c:when>
</c:choose>
...
<fieldset class="voterInfo">
  <div class="row form-group">
    <div class="voterType">
       ...
       <div class="col-xs-8">
        <form:select id="voterClassificationType" path="voterClassificationType" cssErrorClass="error" class="form-control">
