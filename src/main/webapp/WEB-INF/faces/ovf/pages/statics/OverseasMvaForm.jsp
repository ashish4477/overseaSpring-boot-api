...
<form:form modelAttribute="${modelAttr}" action="${faction}" method="post" name="${fname}" id="${fid}" class="userFields" onSubmit="return setPhone();">
<div class="row">
<div>
  <ul>
    <li>If you have already requested an absentee ballot but have not yet received it, you can still vote by using the <a href="https://www.overseasvotefoundation.org/vote/FwabStart.htm">Federal Write-In Absentee Ballot (FWAB).</a></li>
...
function setPhone()
{
    ...
    var temp2=document.getElementById("countryCode").value;
    document.getElementById("phone").value=temp2+"-"+temp1;
    return true;
}
</script>
<script type="text/javascript">
