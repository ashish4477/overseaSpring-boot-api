    ...
    <div class="col-md-2 col-sm-3 hidden-xs">
      <div class="usvote-callout-header">
		...
		<div class="col-xs-2 col-sm-3 col-md-2 hidden-xs account">
            ...
            <li><a type="button" class="btn btn-primary" style="background-color:#b20837;" href="https://www.usvotefoundation.org/donate" target="_blank">Donate Now!</a></li>
			</ul>
		</div>
    </div>
    </div>
      ...
      <div class="container text-center">
        ...
        <div class="container main-navigation">
          <ul class="nav nav-justified" id="navbar">
            ...
            <li class="leaf visible-xs"><a href="<c:url value="/Login.htm"/>">Voter Account</a></li>
          </ul>
          </div>
        </div><!-- /.navbar-collapse -->
      </div>
...
<c:choose>
      ...
      <div class="col-xs-12 account-sub-nav">
         <div class="row">
            <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                <ul>
                    <li class="profile"><a href="<c:url value="/MyVotingInformation.htm"/>">Profile</a></li>
                    <!-- li class="contacts"><a href="<c:url value='/MyKeyContacts.htm'/>">Contacts</a></li TODO: fix it-->
  ...
  <c:choose>
    <c:when test="${sectionName eq 'home'}">
  ...
  <c:choose>
    <c:when test="${sectionName eq 'home'}">
      <div class="bottom-toolkit text-center hidden-lg hidden-md">
        <a href="https://www.facebook.com/overseas.vote.foundation" class="icon-facebook" target="_blank"><img src="<c:url value="/img/icons/f.png"/>"></a>
        <a href="https://twitter.com/overseasvote" class="icon-twitter" target="_blank"><img src="<c:url value="/img/icons/t.png"/>"></a>
        <a href="https://www.instagram.com/usvote" class="icon-instagram" target="_blank"><img src="<c:url value="/img/icons/i.png"/>"></a>
      </div>
      <section class="about-footer text-center">
        <h3>Overseas Vote is an Initiative of U.S. Vote Foundation</h3>
          <ul class="list-inline text-center">
          <li><a href="https://www.usvotefoundation.org/what-we-do" target="_blank">About</a></li>
          <li><a href="https://www.usvotefoundation.org/vision-and-mission" target="_blank">Mission</a></li>
          <li><a href="https://www.usvotefoundation.org/who-we-are" target="_blank">Team</a></li>
          <li><a href="https://www.usvotefoundation.org/contact" target="_blank">Contact</a></li>
          <li><a href="https://www.usvotefoundation.org/Study-Abroad-and-Vote-Toolkit" target="_blank">Study Abroad and Vote! Toolkit</a></li>
        </ul>
      </section>
    </c:when>
  </c:choose>
...
<footer class="footer">
  <ul class="list-inline text-center">
    ...
    <li><a href="https://www.usvotefoundation.org/donate" target="_blank">Donate</a></li>
  </ul>
