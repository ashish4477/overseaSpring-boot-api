    ...
    <div id="eod-form" class="<c:if test="${not (isSvid and isEod)}">svid </c:if>page-form">
      ...
      <c:if test="${empty showCaptcha}">
        <div class="panel-group" id="accordion3" role="tablist" aria-multiselectable="true">
          ...
          <c:if test="${not empty uocavaOffice && isEod}">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-9">
                ...
                <%--
                        ...
                        <br/>
                            <div class="last-updated pull-right">Updated&nbsp;<b><fmt:formatDate value="${uocavaOffice.updated}" pattern="MM/dd/yyyy" /></b></div>
                        </div>
                --%>
            </div>

            <div class="panel panel-default">
              <div class="panel-heading svid collapsed" data-toggle="collapse" data-target="#collapseUocavaEodAddress" role="tab">
                <h4 class="panel-title">
                  <a role="button" class="accordion-toggle" data-toggle="collapse" href="#collapseUocavaEodAddress" aria-expanded="true" aria-controls="collapseUocavaEodAddress">Address Information</a>
                </h4>
              </div>
              <div id="collapseUocavaEodAddress" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body no-table">
            ...
            <div class="panel panel-default">
              <div class="panel-heading svid collapsed" data-toggle="collapse" data-target="#collapseUocavaEodOfficialContact" role="tab">
                <h4 class="panel-title">
                  <a role="button" class="accordion-toggle" data-toggle="collapse" href="#collapseUocavaEodOfficialContact" aria-expanded="true" aria-controls="collapseUocavaEodOfficialContact">Election Official Contact Details</a>
                </h4>
              </div>
              <div id="collapseUocavaEodOfficialContact" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body eod svid">
                  <div class="table-responsive">
                    <table class="table eod">
                      ...
                      <c:if test="${not empty uocavaOffice.generalEmail}">
                        <tr>
                          <td><h4>Election Office Email Address</h4></td>
                          <td><a href="mailto:${uocavaOffice.generalEmail}">${uocavaOffice.generalEmail}</a></td>
                        </tr>
                      </c:if>
                    </table>
                  </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading svid collapsed" data-toggle="collapse" data-target="#collapseUocavaEodAdditional" role="tab">
                <h4 class="panel-title">
                  <a role="button" class="accordion-toggle" data-toggle="collapse" href="#collapseUocavaEodAdditional" aria-expanded="true" aria-controls="collapseUocavaEodAdditional">Additional Information</a>
                </h4>
              </div>
              <div id="collapseUocavaEodAdditional" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body no-table">
                  <div class="accordian-sect office-hours">
                    <dl class="row"><dt class="col-xs-12 col-sm-6"><h4>Office Hours</h4></dt>
                      <dd class="col-xs-12 col-sm-6">
                  ...
                  <div class="accordian-sect further-instructions">
                    <dl class="row"><dt class="col-xs-12 col-sm-6"><h4>Further instructions</h4></dt>
                      <dd class="col-xs-12 col-sm-6">
                        <c:choose>
                          <c:when test="${not empty uocavaOffice.furtherInstruction}">${fn:replace(fn:escapeXml(uocavaOffice.furtherInstruction),newLineChar,"<br />")}</c:when>
                          <c:otherwise>none on record</c:otherwise>
                        </c:choose>
                      </dd></dl>
                  </div>
            ...
            <c:choose>
              <c:when test="${not empty uocavaOffice.website}">
                <p>&nbsp;</p>
                <a class="button small pull-right" href="<c:out value='${uocavaOffice.website}'/>" target="_blank">${uocavaOffice.region.name} Local Elections Website</a>
                <p>&nbsp;</p>
              </c:when>
            </c:choose>
            <div class="corrections hidden-xs">
