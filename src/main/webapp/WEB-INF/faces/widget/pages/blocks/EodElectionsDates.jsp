  ...
  <c:if test="${not empty localElections}">
    ...
    <c:forEach items="${localElections}" var="election">
      ...
      <div class="row show-grid match-my-cols election-dates uocava">
        <div class="col-xs-12 col-sm-4"><h3>Voter Registration</h3>
        ...
        <div class="col-xs-12 col-sm-4"><h3>Ballot Request</h3>
        ...
        <div class="col-xs-12 col-sm-4"><h3>Ballot Return</h3>
