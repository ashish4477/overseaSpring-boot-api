		...
		<div class="bd-inner">
            <c:if test="${not formValid}">
                <div class="download-box">
                    <c:choose>
                        <c:when test="${expired}">
                            <div id="update-message" class="alert alert-warning">The download link has expired. Please  <a href="<c:url value="/home.htm"/>">restart the data entry process</a> to continue.</div>
                        </c:when>
                        <c:otherwise>
                            <div id="update-message" class="alert alert-warning">There is no form to download. Please <a href="<c:url value="/home.htm"/>">restart the data entry process</a> login to continue.</div>
                        </c:otherwise>
                    </c:choose>
                </div>
            </c:if>
